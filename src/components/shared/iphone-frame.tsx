          ...
          <div className="relative rounded-[2rem] overflow-hidden bg-black w-[312px] h-[648px]">
            ...
            <div className="relative z-20 flex items-center justify-between px-6 pt-2 pb-0.5 bg-white">
              ...
              <div className="flex items-center gap-0.5">
                <svg width="11" height="8" viewBox="0 0 15 10" className="text-slate-900">
                ...
                <svg width="9" height="8" viewBox="0 0 13 10" className="text-slate-900">
                ...
                <svg width="18" height="8" viewBox="0 0 22 10" className="text-slate-900">
            ...
            {/* Home indicator */}
            <div className="absolute bottom-1 left-1/2 -translate-x-1/2 w-20 h-[3px] bg-slate-300/50 rounded-full z-20" />
          </div>
        </div>
      </div>
    </div>
